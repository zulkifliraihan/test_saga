            ...
            <div class="content-body">
                ...
                <section id="basic-horizontal-layouts">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="form form-horizontal" id="edit-user-form" action="{{ route('dashboard.user.update', $user->id) }}" method="POST">
                                @method('PATCH')
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <input type="text" id="fname-icon" class="form-control" name="name" value="{{ $user->name }}" placeholder="Nama" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="input-group input-group-merge ">
                                                    ...
                                                    <input type="email" id="email-icon" class="form-control" name="email" value="{{ $user->email }}" placeholder="Email" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="input-group ">
                                                    <select name="role" id="role" class="form-control">
                                                        ...
                                                        @foreach ($roles as $item)
                                                            <option value="{{ $item->name }}" @if ($item->name == $user->getRoleNames()[0]) selected @endif>{{ ucwords($item->name) }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                    ...
                                    <div class="col-sm-9 offset-sm-3">
                                        <button class="btn btn-primary mr-1">Simpan Perubahan!</button>
        ...
        $('#edit-user-form').on('submit', function(event) {
            ...
            $.ajax({
                ...
                success: (data) => {
                    ...
                    if (data.status == "ok" && data.response == "update-user") {
                        Swal.close();
                        Swal.fire({
                            icon: 'success',
                            title: 'Sukses',
