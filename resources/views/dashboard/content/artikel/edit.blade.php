...
@section('content')
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Edit Artikel</h2>
            ...
            <div class="content-body">
                ...
                <section id="basic-horizontal-layouts">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="formEdit" class="form form-horizontal" method="POST" action="{{ route('dashboard.artikel.update', $artikel->id) }}" enctype="multipart/form-data">
                                @method('PATCH')
                                <div class="row">
                                    <div class="col-12">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="select2 form-control" name="category_id" id="category_id">
                                                    ...
                                                    @foreach ($kategori as $item)
                                                        <option value="{{ $item->id }}" @if ($artikel->category_id == $item->id) selected @endif >{{ $item->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" id="title" class="form-control" name="title" value="{{ $artikel->title }}" placeholder="Title Artikel" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
    ...
    <div class="content_artikel" style="display: none">
        {!! $artikel->content !!}
    </div>
...
@section('custom_js')
    ...
    <script>
        var contentEditor = new Quill('#snow-container .editor', {
        ...
        $(document).ready(function () {
            let get_deskripsi_layanan = $('.content_artikel').html();
            contentEditor.clipboard.dangerouslyPasteHTML(0, get_deskripsi_layanan);
        });
