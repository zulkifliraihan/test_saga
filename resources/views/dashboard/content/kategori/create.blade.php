<div class="modal fade" id="createModalForm" tabindex="-1" role="dialog" aria-labelledby="createForm" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formCreate" class="section" action="{{ route('dashboard.kategori.store') }}" method="POST">
                    <div class="info">
                        <div class="row">
